package com.alex.springboot_redis.util;
...
public class RedisUtils {
    ...
    */
    ...
    /**
     * Description: 将数据存入缓存的集合中
     * CreateDate:  2020/7/8 15:10
     * @param:      key
     * @param :     val
     * @return:  
    */
    ...
    /**
     * Description: 获取key缓存
     * CreateDate:  2020/7/8 15:13
     * @param:      key
     * @return:  
    */
    public static String getFromSet(String key) {
        return (String) redisUtils.redisTemplate.opsForSet().pop(key);
    }
    ...
    public static boolean saveNX(String key, String val) {
        ...
        /** 设置成功，返回 1 设置失败，返回 0 **/
        return (boolean) redisUtils.redisTemplate.execute((RedisCallback<Boolean>) connection -> {
    ...
    public static <T> T getBean(String key, Class<T> clazz) {
        ...
        String value = (String) redisUtils.redisTemplate.opsForValue().get(key);
        if (value == null) {
            return null;
        }
    ...
    public static String getString(String key) {
        ...
        return (String) redisUtils.redisTemplate.opsForValue().get(key);
    }
    ...
    public static List<String> getFromQueue(String key, long size) {
        ...
        boolean flag = (boolean) redisUtils.redisTemplate.execute((RedisCallback<Boolean>) connection -> {
    ...
    public static String popQueue(String key) {
        ...
        return (String) redisUtils.redisTemplate.opsForList().rightPop(key);
    ...
    public static Long getSeqNext(String key) {
        ...
        return (Long) redisUtils.redisTemplate.execute((RedisCallback<Long>) connection -> {
    ...
    public static Double incrFloat(String key, double incrBy) {
        ...
        return (Double) redisUtils.redisTemplate.execute((RedisCallback<Double>) connection -> {
    ...
    public static Set<RedisZSetCommands.Tuple> listSortedsetRev(String key, int start, int end) {
        ...
        return (Set<RedisZSetCommands.Tuple>) redisUtils.redisTemplate.execute((RedisCallback<Set<RedisZSetCommands.Tuple>>) connection -> {
    ...
    public static <T> T getBeanFromMap(String key, String field, Class<T> clazz) {
        ...
        byte[] input = (byte[]) redisUtils.redisTemplate.execute((RedisCallback<byte[]>) connection -> {
    ...
    public static String lpop(String key) {
        ...
        return (String) redisUtils.redisTemplate.opsForList().leftPop(key);
    }
